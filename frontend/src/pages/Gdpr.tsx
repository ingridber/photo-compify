  ...
  try {
    ...
    return (
        <div className={infoStyles.container}>
            <h2 className={infoStyles.title}>Our data protection practices</h2>
            ...
            { user && (
            <>
                <h2 className={infoStyles.title}>Collect your data</h2>
                ...
                <button onClick={handleExport} className={styles.btn}>Download your data</button>

                <h2 className={infoStyles.title}>Delete your account</h2>
                ...
                <button onClick={() => navigate("/profile/account/delete-account")} className={styles.btn}>Redirect to delete account</button>
            </>
            )}
        </div>
    )
